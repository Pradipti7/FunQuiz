export const categories = [
  { id: 'kpop', emoji: '🎵', name: 'K-pop', color: 'from-pink-500 to-rose-500', description: 'BTS, BLACKPINK, TWICE & more' },
  { id: 'bl', emoji: '🎭', name: 'BL', color: 'from-purple-500 to-violet-500', description: 'Thai BL, Anime BL & Drama' },
  { id: 'anime', emoji: '⚔️', name: 'Anime', color: 'from-red-500 to-orange-500', description: 'Naruto, One Piece, JJK & more' },
